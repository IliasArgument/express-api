...
const FollowController = {
  followUser: async (req, res) => {
    ...
    //Условие AND используется для объединения двух условий в одно:
    // followerId должно быть равно userId.
    // followingId должно быть равно followingId.
    ...
    try {
      ...
      // Метод connect используется для установления связи (отношения) между существующими записями в связанных таблицах.
